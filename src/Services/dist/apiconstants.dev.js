...
var ApiConstants = {
  ...
  CANDIDATE_DATA_BY_ID: "".concat(baseUrl, "/candidate"),
  ADMIN_CANDIDATE_UPDATE: "".concat(baseUrl, "/admin/candidate/update"),
  PROFILE: "".concat(baseUrl, "/profile"),
  ADMIN_COMPANY_PASSWORD_RESET: "".concat(baseUrl, "/admin/company/reset")
};
